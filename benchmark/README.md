...
The raw outputs of this code as well as the individual configuration files are saved [here](https://github.com/mackelab/tsnpe_neurips_dev/tree/main/benchmark/results). After all runs were finished, we collected the the data into a pickle file with:
```python
