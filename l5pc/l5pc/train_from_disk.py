...
def train(cfg: DictConfig) -> None:
    ...
    original_dir = join(get_original_cwd(), "../results/simulations_pickle")
    with open(f"{original_dir}/simulations_theta_r{round_}.pkl", "rb") as handle:
        theta = pickle.load(handle)
    with open(f"{original_dir}/simulations_x_r{round_}.pkl", "rb") as handle:
